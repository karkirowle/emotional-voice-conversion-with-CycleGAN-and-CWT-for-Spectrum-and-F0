...
def train(filelist_A, filelist_B, model_dir, model_name, random_seed, val_filelist_A, val_filelist_B, output_dir, tensorboard_log_dir,preprocessing):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--preprocessing', action="store_true", help = 'Preprocess or not')
